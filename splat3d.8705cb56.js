...
`}let o={mean:.01,logScale:.005,theta:.005,color:.005,opacity:.005},c={beta1:.9,beta2:.999,eps:1e-8}},{"@parcel/transformer-js/src/esmodule-helpers.js":"k3151"}],lNzsi:[function(e,r,t){/**
...
fn main(@builtin(global_invocation_id) gid : vec3u) {
  ...
  if (i >= ${r}u) { return; }
  dst[i] = gelu4(src[i]);
}`;return{label:`gelu n${e.n}`,code:t,workgroups:[Math.ceil(r/64),1,1],buffers:[{kind:"slot",slot:e.src},{kind:"slot",slot:e.dst}]}}(e)]}}function v(e,r={}){return e.steps.flatMap((e,t)=>g(e,r,t))}},{"@parcel/transformer-js/src/esmodule-helpers.js":"k3151"}],"2Oqph":[function(e,r,t){/**
